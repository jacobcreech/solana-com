...
There's a [Java sdk](https://sava.software/welcome) built by [Sava Engineering](https://sava.engineering/) that supports most functions to interact with Solana. If you're using Anchor for your Solana programs, you will be able to use [anchor-src-gen](https://sava.software/utilities/anchor-src-gen) with your idl to produce a Java compatible client.
...
Please visit the [Sava Software documentation](https://sava.software/welcome) for more information on using this Java SDK with Solana.